...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mer. 24 mai 2023 à 04:42
...
('c01', 'Laino Shampooing Douche au Thé Vert', 'images/laino-shampooing-douche-au-the-vert-bio-200ml.png', 'FO', '10'),
('c02', 'Klorane fibres de lin baume shampooing', 'images/klorane-fibres-de-lin-baume-apres-shampooing-150-ml.jpg', 'CH', '2'),
...
ALTER TABLE `contenir`
  ...
  ADD CONSTRAINT `contenir_produit0_contenance_FK` FOREIGN KEY (`idProduit`,`id_contenance`) REFERENCES `posseder` (`id_produit`, `id_contenance`);
